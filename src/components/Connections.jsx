...
{/* Action Button */}
                  <button 
                    className="w-full py-2 bg-violet-600/10 text-violet-300 rounded-lg font-medium text-sm border border-violet-500/20 hover:bg-violet-600/20 hover:border-violet-400/40 transition-all duration-200"
